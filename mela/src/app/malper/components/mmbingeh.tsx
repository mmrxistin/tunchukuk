  ...
  <footer className="bg-[#121212] text-white border-t-4 border-[#bb1919] mt-16 font-sans">
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          <h5 className="text-sm font-bold uppercase tracking-wider text-white border-b-2 border-[#bb1919] pb-2 mb-4 inline-block">
            Gazetemiz
          </h5>
        ...
        <div>
          ...
          <ul className="space-y-2.5 list-none p-0 m-0 text-sm text-zinc-300">
            <li><a href="/malper/mmmmm" className="hover:text-red-500 hover:underline transition">Yazarlar</a></li>
            <li><a href="/malper/account" className="hover:text-red-500 hover:underline transition">Forum</a></li>
            <li><a href="/gizlilik" className="hover:text-red-500 hover:underline transition">Gizlilik Politikası</a></li>
            <li><a href="/kullanim-sartlari" className="hover:text-red-500 hover:underline transition">Kullanım Şartları</a></li>
            <li><a href="/kunye" className="hover:text-red-500 hover:underline transition">Künye</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-2 mb-6">
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-8 h-8 flex items-center justify-center bg-zinc-800 hover:bg-[#bb1919] text-white transition rounded-none">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="w-8 h-8 flex items-center justify-center bg-zinc-800 hover:bg-[#bb1919] text-white transition rounded-none">
            ...
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-8 h-8 flex items-center justify-center bg-zinc-800 hover:bg-[#bb1919] text-white transition rounded-none">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 2.156 4.919 5.419.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 5.235-4.919 5.383-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-2.159-4.919-5.383-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-5.234 4.919-5.383 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
            </a>
          </div>
          <div className="flex gap-2">
            <a href="/login" className="bg-[#bb1919] hover:bg-[#901313] text-white text-xs px-4 py-2 font-bold transition">Giriş</a>
            <a href="/signup" className="border border-zinc-700 hover:border-white text-zinc-300 text-xs px-4 py-2 font-bold transition">Üye Ol</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="bg-[#0a0a0a] border-t border-zinc-900 py-4 text-xs text-zinc-500">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-3">
        ...
        <div className="flex gap-4">
          <a href="/gizlilik" className="text-zinc-500 hover:text-white transition">Gizlilik</a>
          <a href="/iletisim" className="text-zinc-500 hover:text-white transition">İletişim</a>
          <a href="/kunye" className="text-zinc-500 hover:text-white transition">Künye</a>
        </div>
      </div>
    </div>
  </footer>
